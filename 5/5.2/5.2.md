...
| Teléfono              | INT    | 99999999 | Números válidos     | N/A      | N/A         | Número de contacto del empleado                    | Información de contacto           |
| Fecha_ingreso         | DATE        | AAAA-MM-DD    | Válido en calendario | N/A      | N/A         | Fecha en que el empleado ingresó a la empresa      | Temporalidad                      |
| Estado         | CHAR(20)        | X(20)    | Activo o Inactivo | N/A      | N/A         | Estado del empleado      | Si se encuentra trabajando                      |
...
| Estado           | CHAR(50)    | XXXXXXXXXX   | Pendiente/Aceptada/Rechazada   | N/A      | N/A         | Estado actual de la oferta laboral                        | Condición de la oferta laboral         |
...
| Descripcion           | CHAR(100)   | X(100)   | No nulo           | N/A      | N/A         | DEscripción de la función                             | Descripción de la función de la función |  
...
| Estado           | CHAR(50)    | XXXXXXXXXX   | Activa/Cerrada/En proceso   | N/A      | N/A         | Estado actual de la vacante                         | Condición de la vacante           |
...
| Tipo_entrevista          | CHAR(50)    | XXXXXXXXXX   | Pendiente/Hecha/Rechazada | N/A      | N/A         | Tipo entrevista                        | Tipo entrevista       |
...
| Nombre          | CHAR(50)    | XXXXXXXXXX   | No nulo | N/A      | N/A         | Nombre de la observación                         | Nombre de la observación       |
| Descripción          | CHAR(50)    | XXXXXXXXXX   | No nulo | N/A      | N/A         | Descripción de la observación                        | Descripción de la observación       |
...
# Entidad: Postmortem_detalles

| Atributo | Naturaleza | Formato | Valores Válidos | Unidad | Derivada de | Semántica | Ontología |
|----------|------------|---------|-----------------|--------|-------------|-----------|-----------|
| cod_postmortem | INT | 9999 | > 0 | N/A | N/A | Identificador único del detalle postmortem | Identificación del postmortem |
| resumen_post | CHAR(20) | XXXXXXXXXXXX | No nulo | N/A | N/A | Resumen del postmortem | Resumen del análisis |
| Impacto | CHAR(50) | XXXXXXXXXXXX | No nulo | N/A | N/A | Descripción del impacto del incidente | Impacto generado |
| Deteccion | CHAR(50) | XXXXXXXXXXXX | No nulo | N/A | N/A | Descripción de cómo fue detectado el incidente | Método de detección |
| Recuperacion | CHAR(50) | XXXXXXXXXXXX | No nulo | N/A | N/A | Descripción de cómo se recuperó el incidente | Estrategia de recuperación |
| Severidad | CHAR(50) | XXXXXXXXXXXX | No nulo | N/A | N/A | Grado de severidad del incidente | Nivel de severidad |
| cod_ticket_post | INT | 9999 | > 0 | N/A | Ticket_postmortem | Relación con el ticket postmortem | Relación con postmortem |

# Entidad: Analisis_post

| Atributo | Naturaleza | Formato | Valores Válidos | Unidad | Derivada de | Semántica | Ontología |
|----------|------------|---------|-----------------|--------|-------------|-----------|-----------|
| cod_analisis_post | INT | 9999 | > 0 | N/A | N/A | Identificador único del análisis postmortem | Identificación de análisis |
| Aprobacion_analisis | CHAR(50) | XXXXXXXXXXXX | Aprobado/Rechazado | N/A | N/A | Estado de aprobación del análisis postmortem | Aprobación del análisis |
| fecha_inicio_post | DATE | YYYY-MM-DD | Fecha válida | N/A | N/A | Fecha de inicio del análisis postmortem | Tiempo de inicio |
| fecha_fin_post | DATE | YYYY-MM-DD | Fecha válida | N/A | N/A | Fecha de finalización del análisis postmortem | Tiempo de finalización |
| cod_postmortem | INT | 9999 | > 0 | N/A | Postmortem_detalles | Relación con el postmortem | Relación con postmortem |

# Entidad: Leccion

| Atributo | Naturaleza | Formato | Valores Válidos | Unidad | Derivada de | Semántica | Ontología |
|----------|------------|---------|-----------------|--------|-------------|-----------|-----------|
| cod_leccion | INT | 9999 | > 0 | N/A | N/A | Identificador único de la lección | Identificación de lección |
| Leccion | CHAR(255) | XXXXXXXXXXXX | No nulo | N/A | N/A | Descripción de la lección aprendida | Detalles de la lección |
| cod_analisis_post | INT | 9999 | > 0 | N/A | Analisis_post | Relación con el análisis postmortem | Relación con análisis |

# Entidad: Categoria_Accion

| Atributo | Naturaleza | Formato | Valores Válidos | Unidad | Derivada de | Semántica | Ontología |
|----------|------------|---------|-----------------|--------|-------------|-----------|-----------|
| cod_cat_accion | INT | 9999 | > 0 | N/A | N/A | Identificador único de la categoría de acción | Identificación de categoría |
| cat_accion | CHAR(15) | XXXXXXXXX | No nulo | N/A | N/A | Descripción de la categoría de la acción | Clasificación de acciones |
| cod_accion | INT | 9999 | > 0 | N/A | N/A | Identificador de la acción | Relación con acciones |

# Entidad: Accion

| Atributo | Naturaleza | Formato | Valores Válidos | Unidad | Derivada de | Semántica | Ontología |
|----------|------------|---------|-----------------|--------|-------------|-----------|-----------|
| cod_accion | INT | 9999 | > 0 | N/A | N/A | Identificador único de la acción | Identificación de la acción |
| accion | CHAR(255) | XXXXXXXXX | No nulo | N/A | N/A | Descripción de la acción realizada | Detalles de la acción |
| cod_analisis_post | INT | 9999 | > 0 | N/A | Analisis_post | Relación con el análisis postmortem | Relación con análisis |
| cod_cat_accion | INT | 9999 | > 0 | N/A | Categoria_Accion | Relación con la categoría de acción | Relación con categoría |

# Entidad: Incidente

| Atributo | Naturaleza | Formato | Valores Válidos | Unidad | Derivada de | Semántica | Ontología |
|----------|------------|---------|-----------------|--------|-------------|-----------|-----------|
| cod_incidente | INT | 9999 | > 0 | N/A | N/A | Identificador único del incidente | Identificación del incidente |
| descripcion | CHAR(255) | XXXXXXXXX | No nulo | N/A | N/A | Descripción del incidente | Detalles del incidente |
| severidad | CHAR(10) | XXXXXXXXX | Baja/Media/Alta | N/A | N/A | Nivel de severidad del incidente | Grado de severidad |
| cod_ticket_inc | INT | 9999 | > 0 | N/A | Ticket_incidente | Relación con el ticket de incidente | Relación con incidente |

# Entidad: Diagnostico

| Atributo | Naturaleza | Formato | Valores Válidos | Unidad | Derivada de | Semántica | Ontología |
|----------|------------|---------|-----------------|--------|-------------|-----------|-----------|
| cod_diagnostico | INT | 9999 | > 0 | N/A | N/A | Identificador único del diagnóstico | Identificación de diagnóstico |
| diagnostico | CHAR(255) | XXXXXXXXX | No nulo | N/A | N/A | Descripción del diagnóstico | Detalles del diagnóstico |
| cod_incidente | INT | 9999 | > 0 | N/A | Incidente | Relación con el incidente | Relación con incidente |

# Entidad: Proveedor

| Atributo | Naturaleza | Formato | Valores Válidos | Unidad | Derivada de | Semántica | Ontología |
|----------|------------|---------|-----------------|--------|-------------|-----------|-----------|
| cod_proveedor | INT | 9999 | > 0 | N/A | N/A | Identificador único del proveedor | Identificación del proveedor |
| proveedor | CHAR(255) | XXXXXXXXX | No nulo | N/A | N/A | Nombre del proveedor | Detalles del proveedor |
| cod_incidente | INT | 9999 | > 0 | N/A | Incidente | Relación con el incidente | Relación con incidente |
...
| Atributo | Naturaleza | Formato | Valores Válidos | Unidad | Derivada de | Semántica | Ontología |
|----------|------------|---------|-----------------|--------|-------------|-----------|-----------|
| cod_causa | INT | 9999 | > 0 | N/A | N/A | Identificador único de la causa | Identificación de causa |
| descripcion | CHAR(255) | XXXXXXXXX | No nulo | N/A | N/A | Descripción de la causa | Detalles de la causa |
| cod_incidente | INT | 9999 | > 0 | N/A | Incidente | Relación con el incidente | Relación con incidente |
