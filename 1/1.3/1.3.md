...
| Nro | Actividad                                | Descripción                                                                 | Responsable                  |
|-----|------------------------------------------|-----------------------------------------------------------------------------|------------------------------|                       |
| 1   | Proceso de Inducción (Onboarding)        | Se proporciona información inicial sobre la cultura de la empresa, políticas y beneficios. | Departamento de Gestion RRHH                         |
...
| 5   | Asignación de proyectos                  | El empleado es asignado a uno o varios proyectos en función de su perfil y habilidades. | Lider de Proyectos  |
...
| 9  | Aprobación de permisos o licencias       | La solicitud es revisada por el supervisor o RRHH y se aprueba o rechaza según las políticas de la empresa. | Departamento de Gestion |
...
| 11  | Evaluación del desempeño                 | Se llevan a cabo evaluaciones periódicas del desempeño, considerando proyectos, habilidades y contribuciones. | Supervisor Departamento de Gestion RRHH               |
| 12  | Generación de reportes de desempeño      | Se generan reportes sobre el desempeño individual del empleado, usados para la toma de decisiones gerenciales. | Supervisor Departamento de Gestion RRHH                        |
...
| 15  | Generación de reportes gerenciales       | Se crean reportes generales para la alta dirección, basados en los indicadores clave del personal. | Gerencia Departamento de Gestion                 |
...
| 17  | Revisión de cumplimiento de políticas    | Se verifica que el empleado cumpla con las políticas internas de la empresa y las normativas legales. | Departamento de Gestion RRHH                    |
...
Este proceso abarca desde el registro del comercio hasta la optimización de la atención al cliente. Las interacciones con los comerciantes se clasifican automáticamente, asignando categorías precisas que se registran en el CRM. Además, permite ajustes manuales a través de la interacción con asesores.

| Nro | Actividad                                | Descripción                                                                                          | Responsable              |
|-----|------------------------------------------|------------------------------------------------------------------------------------------------------|--------------------------|
| 1   | Registro del comercio                    | El comerciante completa el formulario con la información requerida sobre el negocio y envía su solicitud.| Comerciante              |
| 2   | Revisión de solicitud                    | El área de comercio revisa la solicitud y verifica los documentos presentados.                          | Área de Comercio     |
| 3   | Aprobación o rechazo                     | Se notifica al comerciante sobre la aprobación o el rechazo de su registro, con los motivos en caso de rechazo. | Equipo de validación     |
| 4   | Configuración de métodos de pago         | El comerciante configura sus métodos de pago (QR, enlace de pago, etc.).                              | Comerciante              |
| 5   | Establecimiento de notificaciones        | El comerciante define las preferencias de notificaciones de transacciones y pagos.                    | Comerciante              |
| 7   | Consulta de resumen de ventas            | El comerciante revisa el resumen de ventas diarias, semanales o mensuales en su panel de transacciones. | Comerciante              |
| 8   | Generación de reportes                   | El comerciante genera reportes detallados de sus ventas y transacciones                              | Comerciante              |
| 9   | Contacto con atención al cliente         | El comerciante se pone en contacto con el soporte en caso de dudas o problemas.                       | Comerciante              |
| 10  | Resolución de incidencias                | El equipo de soporte de Yape gestiona las consultas e incidencias presentadas por los comerciantes.    | Área de soporte        |
| 11  | Actualización de información del comercio| El comerciante puede actualizar su información de negocio (dirección, tipo de negocio, etc.).         | Comerciante              |
| 12  | Validación de actualización              | El equipo de Yape valida la información actualizada antes de reflejarla en la plataforma.              | Área de Comercio    |
| 13  | Solicitud de cierre de comercio          | El comerciante solicita el cierre del comercio a través de la aplicación.                             | Comerciante              |
| 14  | Validación del cierre                    | El equipo de Yape revisa y valida la solicitud de cierre del comercio.                                | Área de Comercio     |
| 15  | Cierre del comercio                      | Se procesa el cierre del comercio y se actualiza el estado en la plataforma.                          | Área de Comercio      |
