...
El proceso abarca el registro y la validación de comercios, la configuración de perfiles, la activación de métodos de pago y la capacitación a los comerciantes, garantizando así una integración eficiente en la plataforma.
![MóduloComercial](https://github.com/user-attachments/assets/e55861b0-2052-4039-becc-71cf68ed1087)
| **Actividad**                 | **Descripción**                                                                 | **Responsable**               |
|-------------------------------|---------------------------------------------------------------------------------|-------------------------------|
| **Registro del Comercio**      | El comerciante proporciona información básica del negocio, como nombre, RUC, dirección, etc. | Comerciante |
| **Validación de Documentación**| Revisión de los documentos enviados por el comerciante para garantizar su validez. | Área Comercial           |
| **Configuración de Perfil**    | Creación y configuración del perfil del comercio en la plataforma de Yape.       | Área Comercial |
| **Aprobación de Comercio**     | Decisión final sobre la aprobación del comercio para operar en Yape, basada en la validación previa. | Área Comercial        |
| **Activación de Métodos de Pago**| Configuración de los métodos de pago del comercio, como códigos QR, integración con otros sistemas de pago. | Área Comercial               |
| **Capacitación al Comercio**   | Formación al personal del comercio sobre el uso de la plataforma de Yape.        | Área de Soporte              |
| **Atención de Soporte al Comercio**| Resolución de problemas o dudas que pueda tener el comercio.            | Área de Soporte       |
