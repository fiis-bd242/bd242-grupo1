...
![Diagrama de procesos de la gestión de tipificaciones)](https://github.com/user-attachments/assets/16eb3a2d-7b5f-479d-a86c-abfa8c80c10b)
...
| 14  | Comunicación de seguimiento                   | Se comunica a los yaperos y clientes internos al seguimiento o la resolución de su interacción.                             | Asesor de CRM                 |
| 15  | Monitoreo de la experiencia                   | Se monitorea cómo los cambios en la tipificación afectan la experiencia del cliente con el CRM y la app.                    | Equipo de Customer Experience |
| 16  | Retroalimentación continua                    | Con base en los datos monitoreados, se ajustan los procesos para mejorar la experiencia del cliente.                        | Equipo de Producto y Experiencia|
