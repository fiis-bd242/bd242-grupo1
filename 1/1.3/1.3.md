...
| Actividad                             | Descripción                                                                                                      | Responsable                    |
|---------------------------------------|------------------------------------------------------------------------------------------------------------------|--------------------------------|
| Recolección de Datos                  | Recolectar datos de transacciones, ingresos, monto transaccionado, cantidad transaccionada y monto de conversión.| Equipo de TI                   |
| Integración de Datos                  | Consolidar los datos recolectados en un panel de control central para el análisis.                               | Equipo de Reportes             |
| Generación de Reportes                | Crear reportes que muestren las métricas clave, incluyendo el monto de conversión y si supera el 1%.            | Equipo de Reportes             |
| Análisis de Datos                     | Usar Power BI para visualizar los datos y generar gráficos y tablas.                                            | Analista de Datos               |
| Revisión de Efectividad de Promociones| Determinar si el monto de conversión es mayor al 1% para evaluar la efectividad de las promociones.               | Gerente de Marketing            |
| Toma de Decisiones                    | Tomar decisiones sobre la renovación o continuación de las promociones basadas en los datos analizados.          | Gerente o Supervisor de Marketing|
| Gestión de Reclamos                   | Derivar tickets al área de soporte según los requerimientos recibidos por el área de Experiencia.                | Equipo de Experiencia al Cliente|
