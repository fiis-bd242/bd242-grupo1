...
| Actividad                        | Descripción                                                                                                      | Responsable             |
|-----------------------------------|------------------------------------------------------------------------------------------------------------------|-------------------------|
| Recolección de Datos              | Recolectar datos de transacciones, ingresos, monto transaccionado, cantidad transaccionada y monto de conversión. | Sistema Automatizado     |
| Integración de Datos              | Consolidar los datos recolectados en un panel de control central para el análisis.                                | Sistema de Reportes      |
| Generación de Reportes            | Crear reportes que muestren las métricas clave, incluyendo el monto de conversión y si supera el 1%.             | Sistema de Reportes      |
| Análisis de Datos                 | Usar Power BI para visualizar los datos y generar gráficos y tablas.                                              | Operario (analista)      |
| Revisión de Efectividad de Promociones | Determinar si el monto de conversión es mayor al 1% para evaluar la efectividad de las promociones.               | Gerente o Supervisor     |
| Toma de Decisiones                | Tomar decisiones sobre la renovación o continuación de las promociones basadas en los datos analizados.           | Gerente o Supervisor     |
| Gestión de Reclamos               | Derivar tickets al área de soporte según los requerimientos recibidos por el área de Experiencia.                 | Área de Experiencia      |
