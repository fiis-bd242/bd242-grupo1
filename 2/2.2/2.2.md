...
![MóduloComercialTOBE](https://github.com/user-attachments/assets/14425d4d-aa61-4d1d-adda-df82e3674e7c)
Cambios para mejora del modulo: 
Actualmente no contamos con procesos de retroalimentación, por ello se crearon 2 nuevos procesos:
- Brindar atención personalizada al comercio: Este proceso consiste en dar una retroalimentación constructiva y atención personalizada para poder asesorar al comercio en caso no haya podido registrarse, ya sea por error en la validación o aprobación, y así poder conocer que falta y completar los datos necesarios. Los encargados de esta atención personalizada son el área de soporte.
- Brindar retroalimentación: A través de este proceso, los comercios tendrán la oportunidad de expresar su opinión sobre el uso del servicio mediante una encuesta. Esto nos permitirá conocer sus experiencias y expectativas, y así realizar mejoras significativas en nuestro servicio.
