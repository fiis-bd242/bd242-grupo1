...
-- subida de recursos por parte del usuario
UPDATE Recursos
...
-- Eliminar convocatorias asociadas a la vacante
DELETE FROM Convocatoria
WHERE id_vacante = [ID_VACANTE];

-- Eliminar postulantes asociados a la vacante
...
-- Eliminar registros de la tabla `Idioma_Postulante`
DELETE FROM Idioma_Postulante WHERE id_postulante = [ID_POSTULANTE];

-- Eliminar registros de la tabla `Habilidad_Postulante`
DELETE FROM Habilidad_Postulante WHERE id_postulante = [ID_POSTULANTE];

-- Eliminar registros de la tabla `Oferta_Laboral`
DELETE FROM Oferta_Laboral WHERE id_postulante = [ID_POSTULANTE];

-- Eliminar registros de la tabla `Entrevista`
DELETE FROM Entrevista WHERE id_postulante = [ID_POSTULANTE];

-- Finalmente, eliminar el registro de la tabla `Postulante`
DELETE FROM Postulante WHERE id_postulante = [ID_POSTULANTE];
