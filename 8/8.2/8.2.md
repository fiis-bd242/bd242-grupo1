...
Creación y edición de capacitaciones, junto a la asignación de empleados en cada una, y la creación de recursos y test dentro de una capacitación, para lograr un ambiente de aprendizaje óptimo para los empleados. Recalcar que no solo contamos con procesos CRUD, sino también con otros procesos.

#### Flujo de Actividades

1. Solicitud de una Capacitación: Un empleado externo sugiere una capacitación para sus empleados, por lo que se toma en cuenta y se decide si es necesaria o no
2. Creación de la Capacitación: Se crea la capacitacións y se le asigna a un capacitador.
3. Creación de módulos: Se crean los módulos en la capacitación, para divdir secciones del curso.
4. Creación de recursos: Se introducen recursos en cada módulo, para poder mostrar a los empleados dentro de la capacitación.
5. Creación de tests: Destinados a evaluar si los empleados aprendieron o no en el módulo. Para la creación de un test también se deben crear preguntas y alternativas.
6. Añadir empleados: Se añaden empleados en las capacitaciones, para que puedan seguir el curso y aprender.
7. Verificar retroalimentación: Esto se refiere a ver las retroalimentaciones brindadas por los empleados de la capacitación, para ver que tan buena fue la capacitación.

En el módulo de gestión de capacitaciones los usuarios del área podrán aceptar o rechazar solicitudes, crear una capacitación completa, si se les fue asignada, añadir los empleados requeridos y recibir la retroalimentación del curso.
