...
### 12. | **Realised User task**     | Enviar feedback de la entrevista/prueba al candidato                                                                                                  |
|----------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| **Postcondition**           | El candidato ha recibido el correo y ha descargado el feedback desde el sistema.                                                                      |
