...
| **Used Services**           | - Servicio de listado de propuestas |
| **Non-functional requirements** | - **Seguridad**: El acceso a mis propuestas solo esta permitido para empleados que tengan propuestas de campaña. |
### 4. Caso de uso: Creacion de Prototipo Publicitario

| **Realised User task**     | Presentar ideas creativas para la creación de una nueva campaña. Requerimiento CP-004|
|----------------------------|-------------------------------------------------------------------|
...
### 5. Caso de uso: Pre-test

| **Realised User task**     | Enviar a revisión la audiencia seleccionada en el prototipo. Requerimiento CP-005|
|----------------------------|-------------------------------------------------------------------|
| **Initiating Actors**       | Equipo de Marketing                                        |
...
### 6. Enviar Prototipo a revision

| **Realised User task**     | Enviar a revisión el prototipo CP-006|
|----------------------------|-------------------------------------------------------------------|
| **Initiating Actors**       | Equipo de Marketing                                        |
...
### 7. Caso de uso: Aprobación de prototipo

| **Realised User task**     | Aprobar o rechazar las propuestas de campaña. Requerimiento CP-007|
|----------------------------|-------------------------------------------------------------|
...
---
### 8. Caso de uso: Ajuste y Lanzamiento de Campaña 

| **Realised User task**     | Realizar ajustes a una campaña publicitaria activa. Requerimiento CP-008|
|----------------------------|----------------------------------------------------|
