...
### 2. Caso de uso: Ver las propuestas del usuario creador.

| **Realised User task**     | Ver Mis Propuestas. CP-002|
|----------------------------|-------------------------------------------------------------------|
...
### 3. Caso de uso: Creacion de Prototipo Publicitario

| **Realised User task**     | Presentar ideas creativas para la creación de una nueva campaña. Requerimiento CP-003 |
|----------------------------|-------------------------------------------------------------------|
...
### 4. Caso de uso: Pre-test

| **Realised User task**     | Enviar a revisión la audiencia seleccionada en el prototipo. Requerimiento CP-004|
|----------------------------|-------------------------------------------------------------------|
| **Initiating Actors**       | Equipo de Marketing                                        |
...
### 5. Enviar Prototipo a revision

| **Realised User task**     | Enviar a revisión el prototipo CP-005|
|----------------------------|-------------------------------------------------------------------|
| **Initiating Actors**       | Equipo de Marketing                                        |
...
### 5. Caso de uso: Aprobación de prototipo

| **Realised User task**     | Aprobar o rechazar las propuestas de campaña. Requerimiento CP-005|
|----------------------------|-------------------------------------------------------------|
...
---
### 6. Caso de uso: Ajuste y Lanzamiento de Campaña 

| **Realised User task**     | Realizar ajustes a una campaña publicitaria activa. Requerimiento CP-005|
|----------------------------|----------------------------------------------------|
...
### 7     . Caso de uso: Generación de Reportes

| **Realised User task**     | Generar un informe detallado del rendimiento de la campaña publicitaria. Requerimiento CP-004|
|----------------------------|--------------------------------------------------------------------------------------------|
| **Initiating Actors**       | Administrador de Marketing                                                                 |
