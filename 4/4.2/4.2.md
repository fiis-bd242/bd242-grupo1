...
| **Realised User task**     | Presentar ideas creativas para la creación de una nueva campaña. Requerimiento CP-001 |
|----------------------------|-------------------------------------------------------------------|
...
| **Realised User task**     | Enviar a revisión la audiencia seleccionada en el prototipo. Requerimiento CP-002|
|----------------------------|-------------------------------------------------------------------|
| **Initiating Actors**       | Equipo de Marketing                                        |
...
| **Realised User task**     | Activar o rechazar las propuestas de campaña. Requerimiento CP-003|
|----------------------------|-------------------------------------------------------------|
