...
### 1. Caso de uso: Proceso de Inducción (Onboarding)

| **Realised User task**     | Proporcionar información inicial sobre la cultura de la empresa, políticas y beneficios al nuevo empleado. |
|----------------------------|------------------------------------------------------------------------------------------------------------|
| **Initiating Actors**       | Departamento de Gestión de RRHH, Nuevo Empleado                                                            |
| **Participating Actors**    | - Departamento de Gestión de RRHH <br> - Nuevo Empleado <br> - Sistema de Gestión de Empleados              |
| **Flow of Events**          | 1. El nuevo empleado se presenta en el área de Recursos Humanos. <br> 2. El sistema ofrece una vista de introducción con políticas y beneficios. <br> 3. El Departamento de Gestión RRHH conduce el proceso de inducción en base a la información presentada en el sistema. |
| **Exceptions**              | - **Falta de Datos**: Si no se puede acceder a los datos del empleado, el sistema muestra un error y no permite continuar. <br> - **Error de Red**: Si hay problemas con la red, se solicita al usuario intentar nuevamente más tarde. |
| **Preconditions**           | El sistema debe tener acceso a la información necesaria y debe estar en funcionamiento.                    |
| **Postcondition**           | El nuevo empleado ha sido formalmente introducido a la empresa y ha recibido toda la información relevante. |
| **Includes Use Case**       | Validación de datos del empleado                                                                           |
| **Used Services**           | - Servicio de Gestión de Empleados <br> - Servicio de presentación de políticas y beneficios               |
| **Non-functional requirements** | - **Seguridad**: Los datos del empleado deben estar protegidos. <br> - **Usabilidad**: El sistema debe ser fácil de navegar para el nuevo empleado y el equipo de RRHH. |

---

### 2. Caso de uso: Creación y Actualización de Perfil de Empleado
