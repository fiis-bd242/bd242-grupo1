...
| Teléfono              | INT   | 999999999 | Números válidos     | N/A      | N/A         | Número de contacto del empleado                    | Información de contacto           |
| Fecha_ingreso         | DATE        | AAAA-MM-DD    | Válido en calendario | N/A      | N/A         | Fecha en que el empleado ingresó a la empresa      | Temporalidad                      |
| Estado         | CHAR(20)        | X(20)   |  Activo/Inactivo  | N/A      | N/A         | Estado del empleado      | Si está trabajando                      |
...
| Puntaje          | INT   | 999   | >=0           | N/A      | N/A         | Puntaje general del postulante postulante                              | Puntaje general del postulante  |
...
| Id_experiencia   | INT         | 9999         | > 0               | N/A      | N/A         | Identificador único de experiencia la laboral               | Identificador único de la experiencia laboral    |

## Entidad: Idioma postulante

| Atributo         | Naturaleza  | Formato      | Valores válidos   | Unidad   | Derivada de | Semántica                                           | Ontología                         |
|------------------|-------------|--------------|-------------------|----------|-------------|----------------------------------------------------|-----------------------------------|
| Id_idioma_postulante   | INT         | 9999         | > 0               | N/A      | N/A         | Identificador único del idioma postulante             | Identificador único del idioma postulante    |
| Id_idioma  | INT         | 9999         | > 0               | N/A      | N/A         | Identificador único del idioma              | Identificador único del idioma     |
| Id_postulante   | INT         | 9999         | > 0               | N/A      | N/A         | Identificador único del postulante              | Identificador único del postulante     |
...
| Atributo         | Naturaleza  | Formato      | Valores válidos   | Unidad   | Derivada de | Semántica                                           | Ontología                         |
|------------------|-------------|--------------|-------------------|----------|-------------|----------------------------------------------------|-----------------------------------|
| Id_habilidad_postulante   | INT         | 9999         | > 0               | N/A      | N/A         | Identificador único de la habilidad             | Identificador único de la habilidad     |
...
| Id_oferta   | INT         | 9999         | > 0               | N/A      | N/A         | Identificador único de la oferta laboral         | Identificador único de la oferta laboral    |
...
| Estado          | CHAR(50)    | XXXXXXXXXX   | Pendiente/Hecha/Rechazada | N/A      | N/A         | Estado de la entrevista                         | Estado de la entrevista       |
| Tipo_entrevista          | CHAR(50)    | XXXXXXXXXX   | HR/Inicial/Final | N/A      | N/A         | Tipo de entrevista                        | Tipo de entrevista      |
| Puntaje_general              | INT        | 999  | > 0               | N/A    | N/A         | Puntaje ponderado de los indicadores              | Puntaje ponderado de los indicadores    |
| Id_postulante      | INT         | 9999         | > 0                | N/A      | N/A         | Identificador único del postulante               | Quién recibirá la entrevista   |
| Id_empleado      | INT         | 9999         | > 0                | N/A      | N/A         | Identificador único del empleado               | Quién realizara la entrevista   |
...
| Descripción           | CHAR(100)   | XXXXXXXXXX   | No nulo           | N/A      | N/A         | Descripción de la función                             | Descripción de la función |
...
| Atributo         | Naturaleza  | Formato      | Valores válidos   | Unidad   | Derivada de | Semántica                                           | Ontología                         |
|------------------|-------------|--------------|-------------------|----------|-------------|----------------------------------------------------|-----------------------------------|
| Id_convocatoria      | INT         | 9999         | > 0               | N/A      | N/A         | Identificador único de la convocatoria                   | Identificación de la convocatoria      |
...
|------------------|-------------|--------------|-------------------|----------|-------------|----------------------------------------------------|-----------------------------------|
| Id_vacante       | INT         | 9999         | > 0               | N/A      | N/A         | Identificador único de la vacante                   | Identificación de la vacante      |
| Comentario      | CHAR(50)        | XXXXXXXXXX   | No nulo           | N/A      | N/A         | Comentario de la vacante                     | Comentario de la vacante           |
...
| Estado           | CHAR(50)    | XXXXXXXXXX   | Abierta/Cerrada/Vencida   | N/A      | N/A         | Estado actual de la vacante                         | Condición de la vacante           |
| Cantidad           | INT    | 999   | No negativo   | N/A      | N/A         | Cantidad de la vacante                         | Cantidad de la vacante           |
| Id_puesto       | INT         | 9999         | > 0               | N/A      | N/A         | Identificador único del puesto                  | Identificación de la vacante      |
...
| Id_departamento_padre       | INT         | 9999         | > 0               | N/A      | N/A         | Identificador único del departamento padre                   | Saber qué departamento está encima jerárquicamente      |
